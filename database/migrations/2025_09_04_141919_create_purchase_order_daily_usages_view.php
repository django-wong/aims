...
return new class extends Migration
{
    ...
    {
        DB::statement("
            CREATE OR REPLACE VIEW purchase_order_daily_usages AS
            SELECT
                purchase_orders.id AS purchase_order_id,
                timesheet_items.date AS date,
            ...
            GROUP BY
                purchase_orders.id, timesheet_items.date
            ORDER BY
                purchase_order_id, timesheet_items.date;
        ");
    }
    ...
    {
        DB::statement("DROP VIEW IF EXISTS purchase_order_daily_usages;");
    }
};
