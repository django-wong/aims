 ...
 * @property Carbon                     $proposed_from
 * @property Carbon                     $proposed_to
 *
 */
class NotificationOfInspection extends Model implements Attachable
{
    ...
    use BelongsToAssignment, BelongsToClient, BelongsToOrg, DynamicPagination, HasFactory, HasManyAttachments;
