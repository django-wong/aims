...
class NotificationOfInspectionAcceptedByClient extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        $message = (new MailMessage)
            ->subject('Inspection request accepted by client.')
            ->action('View Request', url('/notification-of-inspections/'.$this->noi->id))
            ->view(
                'emails.notification-of-inspection-accepted-by-client', [
                    'noi' => $this->noi,
