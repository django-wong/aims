...
class NotificationOfInspectionRejectedByCoordinator extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        $message = (new MailMessage)
            ->subject('Your inspection request has been rejected.')
            ->action('View Request', url('/notification-of-inspections/'.$this->noi->id))
            ->view(
                'emails.notification-of-inspection-rejected-by-coordinator', [
                    'noi' => $this->noi,
