...
type SegmentedControlListProps = ComponentPropsWithoutRef<
  ...
  return (
    ...
    >
      ...
      <FloatingBackground
        isMounted={mounted}
        lineStyle={lineStyle}
        className={floatingBgClassName}
      />
    </TabsPrimitive.List>
  )
}

type SegmentedControlTriggerProps = ComponentPropsWithoutRef<
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // base
        "peer",
        "relative z-10 py-1 whitespace-nowrap rounded-md px-2 text-sm font-medium text-muted-foreground outline-none",
...
type SegmentedControlContentProps = ComponentPropsWithoutRef<
